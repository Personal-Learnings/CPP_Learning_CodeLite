...
##
## Debug
ProjectName            :=SmartPointersUniquePointers
ConfigurationName      :=Debug
WorkspacePath          :=C:/CPP_Learning_CodeLite/Workspace
ProjectPath            :=C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers
...
ObjectsFileList        :="SmartPointersUniquePointers.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/IPrintable.cpp$(ObjectSuffix) $(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix) $(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/IPrintable.cpp$(ObjectSuffix): IPrintable.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers/IPrintable.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/IPrintable.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix): SavingsAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers/SavingsAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/SavingsAccount.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix): CheckingAccount.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/CPP_Learning_CodeLite/Workspace/SmartPointersUniquePointers/CheckingAccount.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CheckingAccount.cpp$(ObjectSuffix) $(IncludePath)
